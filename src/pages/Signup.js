    ...
    <div className="text-2xl bg-image h-screen w-full flex items-center justify-center">
      <div className="flex flex-col items-center justify-center  w-full mt-12">
        <div className="flex text-white flex-col items-center justify-center w-full mb-5 gap-3">
          ...
          <h2 className="text-xl font-semibold">Fill in form to create your Account</h2>
        </div>
        <form
            ...
            <div className="flex flex-col mb-3 w-full">
              ...
              <div className="pr-3 w-full bg-white rounded-md">
                <select
                  ...
                  className="w-full px-3 text-base py-3 rounded-md bg-white border-none outline-none"
                >
